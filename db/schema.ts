...
export const shadowLiveProgressEventsTableSql = `CREATE TABLE IF NOT EXISTS shadow_live_progress_events (
...
export const shadowLiveConnectionSequenceIndexSql = `CREATE INDEX IF NOT EXISTS idx_shadow_live_connection_sequence
