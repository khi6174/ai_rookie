...
export const BoundaryScene = ({index}: {readonly index: number}) => (
  <SceneChrome
    index={index}
    kicker="10 · RESPONSIBLE AI"
    title="판정은 엔진이, 설명은 국내 AI가"
    note="A.X Local은 자격 검증만 완료 · 공개 runtime은 Upstage Hosted + 안전 템플릿"
    dark
  >
    <div
      style={{
    ...
    >
      ...
      >
        ...
        >
          AI는 수치·추천·실행 가능성을 만들거나 바꾸지 못합니다.
        </div>
      </section>
    </div>
  </SceneChrome>
