...
- Playwright 관리자–두 기사 폐루프·새 ID reset·키보드·지도 drag/keyboard pan·4개 해상도·스크린샷·G4-B 부하 17/17과 서버 clean start 3회 통과
