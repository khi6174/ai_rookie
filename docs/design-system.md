...
| `--color-blue-700` | `#315E9E` | 링크·정보 |
| `--color-blue-100` | `#E8F0FA` | 정보 배경 |
...
| `--color-purple-700` | `#6D4AA2` | 수정 요청 |
| `--color-purple-100` | `#F0EAF8` | 수정 요청 배경 |
...
- 동의: filled teal
- 수정 요청: outlined purple 또는 neutral
...
- 오프화이트·네이비·틸·앰버를 기본으로 하고 빨강은 현재 임계치 초과·차단에만 사용한다.
...
이 문서가 `Approved`가 되기 전까지 색상·레이아웃·컴포넌트 세부값은 구현의 확정 기준이 아니다.
