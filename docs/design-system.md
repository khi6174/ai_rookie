...
- 프로필 카드는 큰 정사각형 사진을 위에 두고 이름·지정구역·안전여유를 아래에 쌓는 세로형이다. 안전여유는 Safety Budget 숫자와 색상 외 상태기호를 함께 표시하며 기사 성과 점수로 부르지 않는다. 소셜 프로필의 팔로워·인증·소개문·Follow 행동은 가져오지 않는다.
