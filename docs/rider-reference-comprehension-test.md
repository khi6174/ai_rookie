...
- 담당: 팀 안전빵
- 최종 갱신: 2026-07-21
- 평가 ID: `rider-route-product-boundary-001`
- 데이터 상태: `Demo fixture`
...
- 화면: `artifacts/evals/screenshots/rider-source-route-390x844.png`
- manifest: `artifacts/evals/rider-reference-stimulus-manifest.json`
...
4. 마지막 참여자 완료 후 `rider-reference-comprehension-results.json`을 내려받는다.
...
- 실제 독립 검토자 5명의 일정과 진행자
- `NEEDS_REVISION`일 때 수정할 기사 화면 정보위계
