...
| 핵심 평가 증거 bundle | `pnpm run eval:core-artifacts` | Vitest 237/237 재실행, 대표 fixture 3개·frozen 변형 30개·전략 비교 90개·이관 경계 23개·결정 경계 30개 재계산, 국내 AI 공급자/모드 4개·Upstage 설명 12과업·문서 Mock 60쌍, 접근성 결과와 SHA-256 manifest·불변 run 생성 |
...
| Playwright 폐루프·접근성·PWA E2E | `pnpm run test:e2e` | 20/20 통과, 기존 폐루프·reset·키보드·4개 해상도·지도 Fallback·bounded drag/keyboard pan·offline/PWA·G4-B 부하·G5-A 2.5D 전환·복귀·reduced-motion과 G5-B 익명 검토 도구 추가 |
...
| 최신 전체 Vitest | `pnpm test` | 27개 파일, 237/237 통과 |
