...
| 최신 전체 Vitest | `pnpm test` | 22개 파일, 207/207 통과 |
...
| G3-B 설치·오프라인 경계 | `pnpm test`, `pnpm run test:e2e` | manifest·아이콘·versioned app shell, 승인 Demo 계획 30분 TTL·정확 만료·손상 격리, 실제 offline reload와 읽기 전용 계획, 만료 최신 승격 0건, 오프라인 응답 성공 0건; Vitest 207/207·Playwright 16/16 |
