...
- 실제 인증·Live 위치·푸시·서버 동기화, 실제 GPS·배송주소 기반 길찾기·실제 WebGL 3D·DEM·건물과 추가 외부 의존성은 별도 승인 대상으로 유지한다. 승인된 합성 좌표 전용 Kakao Mobility 자동차 길찾기 미리보기는 표시 전용이며 Safety 계산이나 승인 계획을 변경하지 않는다.
