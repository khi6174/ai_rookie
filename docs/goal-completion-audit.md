...
1. `g5-spatial-comprehension-round2-summary.json`: 최소 3명, `comprehensionPassed=true`, `KEEP_OPTIONAL` 또는 `DEFAULT_PROMOTION_CANDIDATE`
2. `rider-reference-comprehension-summary.json`: 최소 5명, `READY_TO_PROMOTE`, 중대 제품 오인 0명
...
- G5-B Round 2 독립 검토자 3명 결과
- 기사 경로·제품 경계 독립 검토자 5명 결과
