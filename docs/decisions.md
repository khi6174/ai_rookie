...
- 결정: 우측 패널은 `선택 기사 / 안전 지원 / 9/20 / 현재 상태 / 위험 / 지원 시점 / 지금 / Safety Margin / 30(한계) / 45(기준) / 배송 분담 · 강남 / 수신 가능 4명 / 최대 11건 / 필요 34건 / 동일 강우셀 영향 18명 / 기사 지원 요청 / 배송 14/31 완료 / 지원 검토 / 안전 지원 점수`를 사용한다. `이관만으로 해소되지 않음`과 반복되는 `순위 아님`은 삭제한다. 선택이 바뀌면 상태·지원 시점·배송 진행은 해당 합성 기사 값으로 함께 바뀐다.
